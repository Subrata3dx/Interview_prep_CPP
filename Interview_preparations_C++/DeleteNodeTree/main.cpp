...
int main()
{
    ...
    while(TRUE)
    {
    cout<<"1: enter data"<<endl<<"2: traverse"<<endl<<"3: delete a node"<<endl<<"4: See the root value"<<endl<<"5: Exit"<<endl;
    ...
    case 4:
        cout<<"Root value is: "<<rr.rootValue()<<endl;
        break;
    ...
    default:
        cout<<"Choose the correct output"<<endl;
        break;
